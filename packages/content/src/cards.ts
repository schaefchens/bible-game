...
export const CARDS: Record<string, CardDef> = {
  ...
  // Co-op support: heals a CHOSEN party member (aim it at a hurt teammate); solo it heals the hero. The
  // draw is faction-agnostic (feeds the shared pile). target:'ally' → picks a party member (else self).
  second_wind: { id: 'second_wind', type: 'skill', layer: 'flesh', cost: 1, target: 'ally', nameKey: 'card.second_wind.name', textKey: 'card.second_wind.text', rarity: 'common', upgradeTo: 'second_wind_plus', effects: [{ kind: 'heal', amount: 4, target: 'ally' }, { kind: 'draw', count: 1 }] },
  ...
  //     out of the reward/shop pool). One per class — the flavour anchor of each playstyle. Each hones
  //     up to +++ via its upgrade chain (like Strike/Guard), climbing one level per fireplace. ---
  wrath: { id: 'wrath', upgradeTo: 'wrath_plus', type: 'attack', layer: 'flesh', cost: 2, target: 'enemy', nameKey: 'card.wrath.name', textKey: 'card.wrath.text', rarity: 'starter', effects: [{ kind: 'damage', amount: 14 }] }, // Zealot: a heavy, zealous blow
  wrath_plus: { id: 'wrath_plus', upgradeTo: 'wrath_plus_plus', type: 'attack', layer: 'flesh', cost: 2, target: 'enemy', nameKey: 'card.wrath_plus.name', textKey: 'card.wrath_plus.text', rarity: 'starter', effects: [{ kind: 'damage', amount: 18 }] },
  wrath_plus_plus: { id: 'wrath_plus_plus', upgradeTo: 'wrath_plus_plus_plus', type: 'attack', layer: 'flesh', cost: 2, target: 'enemy', nameKey: 'card.wrath_plus_plus.name', textKey: 'card.wrath_plus_plus.text', rarity: 'starter', effects: [{ kind: 'damage', amount: 22 }] },
  wrath_plus_plus_plus: { id: 'wrath_plus_plus_plus', type: 'attack', layer: 'flesh', cost: 2, target: 'enemy', nameKey: 'card.wrath_plus_plus_plus.name', textKey: 'card.wrath_plus_plus_plus.text', rarity: 'starter', effects: [{ kind: 'damage', amount: 26 }, { kind: 'applyStatus', status: 'vulnerable', stacks: 1 }] },
  shepherds_staff: { id: 'shepherds_staff', upgradeTo: 'shepherds_staff_plus', type: 'skill', layer: 'flesh', cost: 1, target: 'self', nameKey: 'card.shepherds_staff.name', textKey: 'card.shepherds_staff.text', rarity: 'starter', effects: [{ kind: 'block', amount: 6 }, { kind: 'heal', amount: 3, target: 'self' }] }, // Shepherd: guard + tend
  shepherds_staff_plus: { id: 'shepherds_staff_plus', upgradeTo: 'shepherds_staff_plus_plus', type: 'skill', layer: 'flesh', cost: 1, target: 'self', nameKey: 'card.shepherds_staff_plus.name', textKey: 'card.shepherds_staff_plus.text', rarity: 'starter', effects: [{ kind: 'block', amount: 8 }, { kind: 'heal', amount: 4, target: 'self' }] },
  shepherds_staff_plus_plus: { id: 'shepherds_staff_plus_plus', upgradeTo: 'shepherds_staff_plus_plus_plus', type: 'skill', layer: 'flesh', cost: 1, target: 'self', nameKey: 'card.shepherds_staff_plus_plus.name', textKey: 'card.shepherds_staff_plus_plus.text', rarity: 'starter', effects: [{ kind: 'block', amount: 10 }, { kind: 'heal', amount: 5, target: 'self' }] },
  shepherds_staff_plus_plus_plus: { id: 'shepherds_staff_plus_plus_plus', type: 'skill', layer: 'flesh', cost: 1, target: 'self', nameKey: 'card.shepherds_staff_plus_plus_plus.name', textKey: 'card.shepherds_staff_plus_plus_plus.text', rarity: 'starter', effects: [{ kind: 'block', amount: 12 }, { kind: 'heal', amount: 6, target: 'self' }, { kind: 'draw', count: 1 }] },
  barter: { id: 'barter', upgradeTo: 'barter_plus', type: 'skill', layer: 'flesh', cost: 1, target: 'none', nameKey: 'card.barter.name', textKey: 'card.barter.text', rarity: 'starter', effects: [{ kind: 'draw', count: 2 }] }, // Merchant: turn the deck over
  barter_plus: { id: 'barter_plus', upgradeTo: 'barter_plus_plus', type: 'skill', layer: 'flesh', cost: 1, target: 'none', nameKey: 'card.barter_plus.name', textKey: 'card.barter_plus.text', rarity: 'starter', effects: [{ kind: 'draw', count: 3 }] },
  barter_plus_plus: { id: 'barter_plus_plus', upgradeTo: 'barter_plus_plus_plus', type: 'skill', layer: 'flesh', cost: 1, target: 'none', nameKey: 'card.barter_plus_plus.name', textKey: 'card.barter_plus_plus.text', rarity: 'starter', effects: [{ kind: 'draw', count: 4 }] },
  barter_plus_plus_plus: { id: 'barter_plus_plus_plus', type: 'skill', layer: 'flesh', cost: 1, target: 'none', nameKey: 'card.barter_plus_plus_plus.name', textKey: 'card.barter_plus_plus_plus.text', rarity: 'starter', effects: [{ kind: 'draw', count: 4 }, { kind: 'gainEnergy', amount: 1 }] },
  ...
  second_wind_plus: { id: 'second_wind_plus', type: 'skill', layer: 'flesh', cost: 1, target: 'ally', nameKey: 'card.second_wind_plus.name', textKey: 'card.second_wind_plus.text', rarity: 'common', effects: [{ kind: 'heal', amount: 6, target: 'ally' }, { kind: 'draw', count: 1 }] },
