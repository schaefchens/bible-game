...
export const CARDS: Record<string, CardDef> = {
  ...
  subdue_plus: { id: 'subdue_plus', type: 'attack', layer: 'flesh', cost: 1, target: 'enemy', nameKey: 'card.subdue_plus.name', textKey: 'card.subdue_plus.text', rarity: 'uncommon', nonLethal: true, effects: [{ kind: 'damage', amount: 12 }] },
